...
export class Block implements Entity {
  ...
  constructor(private readonly scene: GameScene, worldPosition: Vector3 = new Vector3(0, 0, 0)) {
    this.sprite = new Sprite(this.scene.game.spritesheets[0].textures[Texture.GrassBlock])
